...
module la_receiver_0(acq_data_out, acq_data_valid, 
  raw_signal_result, raw_signal_update, lock_level, rx_pixel_clk, sampler_idle, reset, 
  refclkin, clkin1_p, clkin1_n, datain1_p, datain1_n)
/* synthesis syn_black_box black_box_pad_pin="acq_data_out[50:0],acq_data_valid,raw_signal_result[255:0],raw_signal_update,lock_level[2:0],rx_pixel_clk,sampler_idle,reset,refclkin,clkin1_p,clkin1_n,datain1_p[3:0],datain1_n[3:0]" */;
